...
//Interaction for login test task
public class LoginPage implements Interaction {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(Enter.theValue("yohel").into(INPUT_USERNAME));
        actor.attemptsTo(Enter.theValue("yohel").into(INPUT_PASSWORD));
    ...
    public static LoginPage findItAndLogin(){
